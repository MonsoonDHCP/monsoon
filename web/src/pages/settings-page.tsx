...
export function SettingsPage() {
  const { settings, saveSettings, currentUser, authTokens, tokenSecret, loginWithPassword, bootstrapAndLogin, logoutCurrentUser, createToken, revokeToken } = useDashboard()
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <Button onClick={() => void saveSettings(local)}>
            ...
            <div className="space-y-3 rounded-xl border border-border/70 bg-background/50 p-3">
              ...
              <div className="grid gap-3 md:grid-cols-2">
                ...
                <div className="md:col-span-2 flex justify-end">
                  <Button onClick={() => void createToken(tokenForm)}>
